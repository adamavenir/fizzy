Rails.application.routes.draw do
  ...
  scope :beads do
    ...
    scope "boards/:board_id" do
      # Allow dots in issue_id (beads issue IDs can contain dots like "roboco-ijn.8.2")
      resources :issues, param: :issue_id, controller: "beads/issues", only: [:show, :edit, :update, :create, :new, :destroy], constraints: { issue_id: /[^\/]+/ } do
